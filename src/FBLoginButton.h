...
@protocol FBLoginButtonDelegate <NSObject>
 ...
 */
- (void)fbButtonClicked:(BOOL)loggedIn;
...
@interface FBLoginButton : UIControl <FBSessionDelegate> {
	...
	id<FBLoginButtonDelegate> _delegate;
}
...
@property(nonatomic,assign) IBOutlet id<FBLoginButtonDelegate> delegate;
